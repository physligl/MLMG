...
\section{Ghost Readiness 比“调用 MPI”更基础}
...
\section{Interior/Boundary 分裂暴露通信重叠}
...
\section{Surface-to-Volume 决定 Strong Scaling 的几何极限}
...
\section{Global Reduction 是另一类 Scaling 极限}
...
\section{完整分布式 V-Cycle 是通信与计算交织的 DAG}
...
\section{粗化会同时恶化 Local Work 与 Rank Utilization}
...
\section{Rank Consolidation 本质是所有权重映射}
...
\section{Strong Scaling 与 Weak Scaling 应分别理解}
