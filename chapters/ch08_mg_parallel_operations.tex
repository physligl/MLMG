...
\subsection{Line Smoother 与 Block Smoother}
...
\subsection{限制的 Coarse-Output Gather}
...
\subsection{延拓的 Fine-Output Gather}
...
\section{数据生命周期、Kernel Fusion 与 Buffer Reuse}
