...
\begin{keybox}
\textbf{目的：}把\chapref{ch:two-grid}的式~\eqref{eq:galerkin}展开成可逐行检查的一维计算，验证标准 prolongation/full-weighting 下 Galerkin coarse operator 确实回到标准 $2h$ Poisson 离散。建议先复习\chapref{ch:two-grid}的 $R$、$P$ 定义。
\end{keybox}
